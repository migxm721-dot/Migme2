 ...
 */
public class SignupEmailResultUsedFragment extends BaseSignupVerifyFragment {

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mCurrentFragmentKey = LoginActivity.PreloadedFragmentKey.TOKEN_USED.toString();
        setPageLayout(VerifiedResultType.TOKEN_USED);
    }
