...
public class ToolTip {
    ...
    public static final int ANIMATIONTYPE_FADE = 103;
    //
    ...
    private ToolTipRelativePositionEnum toolTipRelativePositionEnum = ToolTipRelativePositionEnum.AUTO;
    ...
    public ToolTip withRelativePosition(ToolTipRelativePositionEnum toolTipRelativePositionEnum) {
        this.toolTipRelativePositionEnum = toolTipRelativePositionEnum;
        return this;
    }
    ...
    /**
     * Set the text color of the ToolTop. Default is white.
     *
     * @return this ToolTip to build upon.
     */
    ...
    public ToolTipRelativePositionEnum getRelativePosition() {
        return toolTipRelativePositionEnum;
    }
