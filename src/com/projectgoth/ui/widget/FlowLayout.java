 ...
 * Created Jul 30, 2013, 2:06:17 PM
 */
...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpace, 10);
            verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpace, 10);
