...
public class SlidingLayer extends FrameLayout {
    ...
    private static final int MIN_DISTANCE_FOR_FLING = 1; // in dip
...
//        final TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SlidingLayer);
        ...
        setStickTo(STICK_TO_TOP);

        // Sets the shadow drawable
        int shadowRes = INVALID_VALUE;
...
//        ta.recycle();
     ...
     * {@link com.wunderlist.slidinglayer.SlidingLayer.OnInteractListener}.
     *
     ...
     * {@link com.wunderlist.slidinglayer.SlidingLayer.OnScrollListener}.
     *
     * @param listener Listener to set
     */
...
//                break;
            case MotionEvent.ACTION_UP:
                ...
                if (mIsDragging) {
                    ...
                    // prevent totally closed
                    if (nextState == STATE_CLOSED) {
                        nextState = STATE_PREVIEW;
                    }
    ...
    public void setDrawingCacheEnabled(boolean enabled) {
        //force to turn off drawing cache to see if we can avoid
        //the discussion is here
        //https://github.com/wunderlist/android-sliding-layer-lib/issues/6
